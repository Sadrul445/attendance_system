                    ...
                    <li class="dropdown">
                        ...
                        <ul class="nav-submenu menu-content" style="display: none;">
                            ...
                            @elseif(auth()->user()->role === 'employee')
                                <li><a href="{{ route('employee.individual', ['employeeId' => auth()->user()->id]) }}">Today My Attendance</a></li>
                            @endif
                        </ul>
                    </li>
                    {{-- <li class="dropdown">
                        <a class="nav-link menu-title " href="javascript:void(0)"><i class="fa-solid fa-calendar-days fa-lg"></i><span class="ms-3">Daily Attendance</span></a>
                        <ul class="nav-submenu menu-content" style="display: none;">
                            <li><a href="javascript:void(0)" class="#">Show Daily Attendance</a></li>
                        </ul>
                    </li> --}}
                    <li class="dropdown">
                        <a class="nav-link menu-title " href="javascript:void(0)"><i
                                data-feather="airplay"></i><span>Profile</span></a>
                        <ul class="nav-submenu menu-content" style="display: none;">
                            <li><a href="{{ route('profile.edit') }}" class="#">Update Profile</a></li>
                        </ul>
                    </li>
